...
public class DamageImageFragment extends Fragment {

    private MainViewModel mViewModel;
    @BindView(R.id.btnDamageImageContinue)
    AppCompatButton btnContinue;
    @BindView(R.id.tvToolBarTitle)
    AppCompatTextView toolBarTitle;
    @BindView(R.id.ivLeftArrow)
    AppCompatImageView ivBackArrow;
    public static DamageImageFragment newInstance() {
        return new DamageImageFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.damage_image_fragment, container, false);
